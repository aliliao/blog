/* 获取浏览器版本信息和OS信息
 * reference: https://blog.csdn.net/qq_42572322/article/details/88241251
 */
...
function BrowserInfo() {
    ...
    return browerInfo.client.name + " " + browerInfo.client.version;
}
...
function getOsInfo() {
    ...
    if(userAgent.indexOf("win") > -1) {
        ...
        // add by ALI
        var isVer64 = userAgent.indexOf("win64") > -1||userAgent.indexOf("wow64") > -1;
        if (isVer64) {
            version += " x64 Edition"
        } else {
            version += " x32 Edition"
